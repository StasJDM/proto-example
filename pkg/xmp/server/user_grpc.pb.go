...
func (c *userClient) Register(ctx context.Context, in *RegisterUserRequest, opts ...grpc.CallOption) (*id.IdMessage, error) {
	...
	err := c.cc.Invoke(ctx, "/xmp.server.user.User/Register", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _User_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xmp.server.user.User/Register",
	}
...
var User_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "xmp.server.user.User",
	...
	Metadata: "xmp/server/user.proto",
}
